...
- The key is to provide the algorithm along with pseudocode and just enough boilerplate code to get started,
- See how the below example capture the A-Z of a step yet does not provide the entire code
```
Guide for 3.1 =>
